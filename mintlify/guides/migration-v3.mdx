...
<Warning>
  If you have infrastructure (logging pipelines, proxies, reverse proxies) that inspects outgoing
  request URLs for an `access_token` query parameter, it will no longer appear there after upgrading
  to v3.
</Warning>
