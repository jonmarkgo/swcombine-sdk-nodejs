---
title: "Quickstart: make your first SW Combine SDK API call"
description: "Install the SW Combine SDK, initialize a client, call a public endpoint without auth, make an authenticated request, and paginate through list results."
