---
title: "Events resource: in-game activity and event log"
...
keywords: ["swcombine sdk", "events", "event log", "game events", "combat", "faction events", "character events", "inventory events"]
---
